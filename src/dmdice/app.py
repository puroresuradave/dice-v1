...
class DMDice(toga.App):
    def startup(self):
        ...
        box1 = toga.Box(direction=COLUMN, margin=10, flex=1)
        box1.add(toga.Button(
            "5e Character",
        ...
        box2 = toga.Box(direction=COLUMN, margin=10, flex=1)
        box2.add(toga.Button(
            "Weather",
        ...
        box3 = toga.Box(direction=COLUMN, margin=10, flex=1)
        box3.add(toga.Button(
            "General Crit",
        ...
        box4 = toga.Box(direction=COLUMN, margin=10, flex=1)
        box4.add(toga.Button(
            "Unarmed Crit",
